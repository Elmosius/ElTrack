  ...
  return (
    <div className='p-4 text-center h-screen w-screen bg-primary'>
      <div className='flex flex-col justify-center items-center w-full h-full gap-2 md:gap-4 lg:gap-6'>
        ...
        <h1 className='text-base text-background'>Page Not Found.</h1>
        <p className='text-sm md:text-base font-light text-background lg:w-1/5'>This page does not exist, please head back home and try again</p>
