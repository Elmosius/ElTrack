  ...
  ],
  {
    variants: {
      variant: {
        default: 'bg-input',
        subtle: 'bg-input/60',
        notion: 'bg-transparent shadow-none ring-0 focus:ring-0 hover:not-[[disabled],[data-disabled]]:not-[:focus]:ring-0',
      },
    },
    defaultVariants: {
      variant: 'default',
...
export function Textarea({ className, variant, ...props }: React.ComponentProps<'textarea'> & VariantProps<typeof textareaVariants>) {
